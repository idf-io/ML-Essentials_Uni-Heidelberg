...
def run():
    ...
    command = f"python main.py play --train 1 --match-name {match_name} --n-rounds {n_rounds} --agents {agent} peaceful_agent peaceful_agent coin_collector_agent --scenario classic --no-gui --save-stats "
    print(command)
