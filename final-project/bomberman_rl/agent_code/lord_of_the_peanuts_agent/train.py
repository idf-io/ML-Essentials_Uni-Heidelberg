...
def is_action_invalid(state, action):
    ...
    if action == 'RIGHT' and all(state[21:24] == [1, 1, 0]):
        ...
        return False
    """
    if action == 'LEFT' and all(state[3:6] == [1, 1, 0]):
        return True
    elif action == 'RIGHT' and all(state[9:12] == [1, 1, 0]):
        return True
    elif action == 'UP' and all(state[12:15] == [1, 1, 0]):
        return True
    elif action == 'DOWN' and all(state[18:21] == [1, 1, 0]):
        return True
    else:
        return False
