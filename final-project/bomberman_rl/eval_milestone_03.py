...
def run():
    ...
    command = f"python main.py play --match-name {match_name} --n-rounds {n_rounds} --agents {agent} peaceful_agent peaceful_agent coin_collector_agent --seed {seed} --scenario classic --no-gui --save-stats --qtable {qtable}"
    print(command)
