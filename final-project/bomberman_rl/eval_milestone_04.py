...
def run():
    ...
    command = f"python3 main.py play --match-name {match_name} --n-rounds {n_rounds} --agents {agent} rule_based_agent rule_based_agent rule_based_agent --scenario classic --no-gui --save-stats --qtable {qtable}"
    print(command)
